...
<html>
	...
	<body>
		<a href="#list-servidor" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-servidor" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="cargo" title="${message(code: 'servidor.cargo.label', default: 'Cargo')}" />
					
						<g:sortableColumn property="setor" title="${message(code: 'servidor.setor.label', default: 'Setor')}" />
